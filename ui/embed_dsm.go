...
//
// The embedded tree is the build output, not the sources: run
// `npm run build:dsm` in this directory before building the daemon, which
// scripts/build-spk.sh does.
package ui
